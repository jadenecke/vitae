...
\documentclass[$if(fontsize)$$fontsize$$else$10pt$endif$,$if(lang)$$babel-lang$,$endif$$if(papersize)$$papersize$$else$a4paper$endif$,$for(classoption)$$classoption$$sep$,$endfor$]{twentysecondcvMod}
...
\languages{$if(languages)$$languages$$endif$}
\skills{$if(skills)$$skills$$endif$}
